...
The whole Svelto framework has been designed to be platform agnostic. This is the simplest proof of concept to make Svelto.ECS work with Net Core and Net Standard projects. This project can be used to build .Net Standard 2.0 dll version of the lib, which is probably a better option then using the standard code when using Net Core < 2.0
